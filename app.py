...
# ==========================================
# 페이지 1: 축제 현황 (차트1을 app.py 산점도로 교체)
# ==========================================
def render_page1():
    ...
    # ── 차트 1: 당일치기 관광 패턴 산점도 (app.py에서 이식) ──
...
def render_page2():
    ...
    fig1 = px.scatter(
        ...
        size="점크기_방문자", color="상권구분", text=reg_col_vac,
